...
- Property pictures, compliance files and general documents upload through short-lived Blob SAS URLs; unsupported MIME types and oversized files are rejected, and authorised download works.
